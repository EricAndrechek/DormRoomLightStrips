        ...
        for i in range(0, length + 1):
            ...
            if beat["start"] != 0 and i <= state4[1]:
                ...
                lights.ceiling_set_pixel(
                    state4[0] + state4[1] - i, (0, 0, 0))
                lights.ceiling_region_fill(
                    state4[0] - state4[1] + i + 1, state4[0] + state4[1] - i - 1, (state4[2][0], state4[2][1], 1 - (i / state4[1]) ** 2))
                ...
                lights.ceiling_set_pixel(
                    state4[0] + state4[1] - i + 43, (0, 0, 0))
                lights.ceiling_region_fill(
                    state4[0] - state4[1] + i + 1 + 43, state4[0] + state4[1] - i - 1 + 43, (state4[2][0], state4[2][1], 1 - (i / state4[1]) ** 2))
            lights.update()
